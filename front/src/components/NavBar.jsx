              ...
              {showDropdown && (
                ...
                >
                  {user ? (
                    <>
                      {user.role === "admin" && (
                        <Link className="dropdown-item" to="/adminpage" onClick={() => setShowDropdown(false)}>Admin Panel</Link>
                      )}
                    ...
                    <>
                      <Link className="dropdown-item" to="/login" onClick={() => setShowDropdown(false)}>Login</Link>
                    </>
                  )}
                </div>
              )}
